...
export default function DeleteButton({ perusahaanId, id, featured }: { perusahaanId: string | number, id: number, featured: string }) {

    const handleDelete = () => {
        const deletes = new Promise((resolve, reject) => {
            router.delete(`/dashboard-perusahaan/${perusahaanId}/${featured}/${id}/delete`, {
